...
class ThemeCubit extends HydratedCubit<Brightness> {
  ThemeCubit() : super(defautlStyle);

  static const Brightness defautlStyle = Brightness.light;
  void updateTheme() {
    var themeState = state == Brightness.light ? Brightness.dark : Brightness.light;
    emit(themeState);
  }
